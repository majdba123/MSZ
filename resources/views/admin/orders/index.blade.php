...
<div class="space-y-4">
    <div class="card p-4">
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-6">
            ...
            <select id="f-vendor" class="rounded-lg border border-gray-200 px-3 py-2 text-sm dark:border-gray-700 dark:bg-gray-800">
        ...
        return `<div class="card p-4">
            ...
            <div class="mt-3 flex items-center justify-between text-xs text-gray-500 dark:text-gray-400">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <a href="/admin/orders/${order.id}" class="rounded-lg border border-gray-200 px-2.5 py-1 text-[11px] font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800">View Details</a>
                </div>
            </div>
        </div>`;
    }
