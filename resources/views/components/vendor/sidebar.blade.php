    ...
    <nav class="flex-1 overflow-y-auto px-4 py-5">
        ...
        <a href="#"
           class="mb-0.5 flex items-center gap-3 rounded-lg px-3 py-2 text-sm font-medium text-gray-400 hover:bg-white/5 hover:text-gray-200 transition-all duration-150">
            ...
            Orders
            <span class="ml-auto rounded-full bg-gray-700 px-2 py-0.5 text-[10px] font-medium text-gray-400">Soon</span>
        </a>

        <p class="mb-2 mt-6 px-3 text-[10px] font-bold uppercase tracking-widest text-gray-500">Settings</p>
